      ...
      <nav className={style.navbar}>
        ...
        <div className={style.btnsContainer}>
          <ul ref={listRef} className={style.list}>
            <li>
              <NavLink onClick={handleOnClick} className={style.btn} to="/home">Home</NavLink>
            </li>
            <li>
              <NavLink onClick={handleOnClick} className={style.btn} to='/create-activities'>Create Activity</NavLink>
            </li>
            <li>
